...
The project also contains a directory called `bank-sdk`. This directory contains a simple example of a banking system to demonstrate how to integrate a banking system with ledger. Any code from this directory can safely be removed. Real solutions will most probably replace this implementation with their own SDK or reference an existing SDK library instead.
